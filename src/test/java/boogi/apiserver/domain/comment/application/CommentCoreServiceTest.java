...
class CommentCoreServiceTest {
    ...
    class CreateCommentTest {
        ...
        void createChildCommentSuccess() {
            ...
            Comment parentComment = Comment.builder()
                    ...
                    .content("부모댓글")
                    .build();
            given(commentValidationService.checkCommentMaxDepthOver(anyLong()))
    ...
    class GetLikeMembersAtCommentTest {
        ...
        void notJoinedUserRequestSuccess() {
            ...
            given(likeRepository.findCommentLikeWithMemberByCommentId(anyLong(), any(Pageable.class)))
                    .willReturn(likePage);
            ...
            LikeMembersAtComment likeMembers = commentCoreService
        ...
        void notJoinedMemberInPrivateCommunityRequestFail() {
            ...
            assertThatThrownBy(() -> commentCoreService
                    .getLikeMembersAtComment(comment.getId(), 2L, pageable))
