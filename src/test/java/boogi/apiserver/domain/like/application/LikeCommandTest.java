...
class LikeCommandTest {
    ...
    class DoLikeAtPostTest {
        ...
        void doLikeAtPostSuccess() {
            ...
            likeCommand.doPostLike(post.getId(), 3L);
        ...
        void alreadyDoLikeFail() {
            ...
            assertThatThrownBy(() -> likeCommand.doPostLike(post.getId(), 1L))
    ...
    class DoLikeAtCommentTest {
        ...
        void doLikeAtCommentSuccess() {
            ...
            likeCommand.doCommentLike(comment.getId(), 1L);
        ...
        void alreadyDoLikeFail() {
            ...
            assertThatThrownBy(() -> likeCommand.doCommentLike(comment.getId(), 1L))
    ...
    class DoUnlikeTest {
        ...
        void requestedUserAndLikedUserNotSameFail() {
            ...
            assertThatThrownBy(() -> likeCommand.doUnlike(like.getId(), 2L))
