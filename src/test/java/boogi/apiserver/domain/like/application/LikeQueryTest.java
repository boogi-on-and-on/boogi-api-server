...
class LikeQueryTest {
    ...
    class GetPostLikeIdTest {
        ...
        void existsPostLike() {
            ...
            Long postLikeId = likeQuery.getPostLikeId(post, member);
    ...
    void getLikeMembersAtPostSuccess() {
        ...
        LikeMembersAtPostResponse response =
                likeQuery.getLikeMembersAtPost(post.getId(), 2L, pageable);
    ...
    void getLikeMembersAtCommentSuccess() {
        ...
        LikeMembersAtCommentResponse response =
                likeQuery.getLikeMembersAtComment(comment.getId(), 2L, pageable);
