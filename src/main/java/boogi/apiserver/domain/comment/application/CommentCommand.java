...
public class CommentCommand {
    ...
    public Long createComment(CreateCommentRequest request, Long userId) {
        ...
        Member member = memberQuery.getMember(userId, findPost.getCommunityId());
    ...
    public void deleteComment(Long commentId, Long userId) {
        ...
        likeCommand.removeAllCommentLikes(findComment.getId());
    ...
    private void validateCommentDeletable(Long userId, Comment comment) {
        ...
        Member sessionMember = memberQuery.getMember(userId, comment.getPost().getCommunityId());
