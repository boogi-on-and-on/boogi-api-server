...
public class PostQuery {
    ...
    public PostDetailResponse getPostDetail(Long postId, Long userId) {
        ...
        Member member = memberQuery.getViewableMember(userId, findPost.getCommunity());
    ...
    public CommunityPostsResponse getPostsOfCommunity(Pageable pageable, Long communityId, Long userId) {
        ...
        Member member = memberQuery.getViewableMember(userId, community);
    ...
    private Long getPostLikeIdForView(Post post, Member member) {
        return member.isNullMember() ? null : likeQuery.getPostLikeId(post, member);
    }
}
